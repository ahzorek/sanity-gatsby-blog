...
const SupportButton = ({accentColor = '#fa0a32', baseColor = '#f6f6f6', size = '50px', border = '1pt'}) => {
  
  const clinchedFist = keyframes`
    from {box-shadow: 0 0 .4rem ${accentColor}}
    to {box-shadow: 0 0 1.2rem ${accentColor}}
  `
  ...
  `
  return (
    <Button onClick={(e) => console.log('I LIVE!')} colors={{accentColor}}>
