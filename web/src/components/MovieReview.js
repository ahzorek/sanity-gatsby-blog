...
const MovieReview = ({ node: { id, rating: vote_hiber = null } }) => {
  ...
  const url = `https://api.themoviedb.org/3/movie/${id}?api_key=${__key}&language=pt-BR`
  ...
  useEffect(() => { fetchData() },[movieInfo.isLoaded])

  if(movieInfo.isLoaded === false) { return <div>Loading...</div> } 
  else {
    const { title, poster_path, release_date, overview, runtime, vote_average, genres } = movieInfo.movie
    return (
      <Wrapper aria-hidden="true">
      <MovieTitle>{title} ({format(parseISO(release_date), "yyyy")})</MovieTitle>
        { poster_path && <Poster alt={`Poster de ${title}`} src={`https://image.tmdb.org/t/p/w400/${poster_path}`}/> }             
        <InfoArea>
          ...
          <div>
            <SubTitle>Lançamento</SubTitle>
              <Text>{format(parseISO(release_date), "dd'/'MM'/'Y")}</Text>
          </div>}
        ...
        <LogoTMDB alt="Logo TMDB" viewBox="0 0 407.34 160.81" style={{fill: '#01d277'}}>
          <polygon className="cls-1" points="50.38 102.47 57.32 102.47 57.32 74.71 65.96 74.71 65.96 67.82 41.74 67.82 41.74 74.71 50.38 74.71 50.38 102.47"/>
          <polygon className="cls-1" points="88.53 102.47 95.47 102.47 95.47 67.77 88.53 67.77 88.53 81.65 78.14 81.65 78.14 67.77 71.2 67.77 71.2 102.47 78.14 102.47 78.14 88.59 88.53 88.59 88.53 102.47"/>
          <polygon className="cls-1" points="121.25 95.53 108.23 95.53 108.23 88.59 119.35 88.59 119.35 81.65 108.23 81.65 108.23 74.71 120.66 74.71 120.66 67.77 101.28 67.77 101.28 102.47 121.25 102.47 121.25 95.53"/>
          <polygon className="cls-1" points="157.79 82.54 144.1 67.3 141.87 67.3 141.87 102.54 148.9 102.54 148.9 83.17 157.79 92.49 166.67 83.17 166.62 102.54 173.66 102.54 173.66 67.3 171.47 67.3 157.79 82.54"/>
          <path className="cls-1" d="M3309.1,1841.93c-23.88,0-23.88,35.77,0,35.77S3333,1841.93,3309.1,1841.93Zm0,28.59c-13.88,0-13.88-21.45,0-21.45S3323,1870.52,3309.1,1870.52Z" transform="translate(-3111.93 -1774.68)"/>
          <rect className="cls-1" x="254.5" y="67.83" width="6.94" height="34.7"/>
          <polygon className="cls-1" points="274.19 95.6 274.19 88.66 285.32 88.66 285.32 81.72 274.19 81.72 274.19 74.78 286.63 74.78 286.63 67.83 267.25 67.83 267.25 102.54 287.21 102.54 287.21 95.6 274.19 95.6"/>
          <path className="cls-1" d="M3429.48,1842.91h-10.34v34.7h10.34C3452.58,1877.61,3452.58,1842.91,3429.48,1842.91Zm0,27.76h-3.4v-20.82h3.4C3443,1849.85,3443,1870.67,3429.48,1870.67Z" transform="translate(-3111.93 -1774.68)"/>
