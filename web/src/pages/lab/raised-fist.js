...
const wrapper = {
  ...
  flexFlow: 'row wrap', 
  alignContent: 'center',
  border: 'solid red 13pt', 
  justifyContent: 'center' }

export default function RaisedFist({accentColor = '#fa0a32', baseColor = 'yellow', size = '50px', border = '1pt'}){
  
  const clinchedFist = keyframes`
    from {box-shadow: 0 0 .8rem ${accentColor}}
    to {box-shadow: 0 0 2rem ${accentColor}}
  `
  const Button = styled.button`
    ...
    & :active {
      ...
      animation: ${clinchedFist} 400ms 3 alternate both;
  ...
  const Fist = styled.svg`
    ...
    height: 60%;
    fill: ${props => props.colors.accentColor};
    ${Button}:active & {
      fill: ${props => props.colors.baseColor};
    }
  `
  return (
    <>
      <Helmet title="The Raised Fist Button -- Suporte, solidariedade e unidade!"/>
      <div style={{...wrapper, backgroundColor: baseColor}}>
        <Button colors={{accentColor}}>
          <Fist colors={{accentColor, baseColor}} viewBox="0 0 65.18 100">
